...
var LINK_OPACITY = .5; //if active, can be changed by a slider in the menu area
var LINK_WIDTH = 1.5;  //if active, can be changed by a slider in the menu area
var OFFSET_LABEL = { x: 5, y: 4 };
var LINK_GAP = 2;  //if active, can be changed by a slider in the menu area
var LAYOUT_TIMEOUT = 3000;
var LABELBACKGROUND_OPACITY = 1;
var LABELDISTANCE = 10;
var SLIDER_WIDTH = 100;
var SLIDER_HEIGHT = 35;
var NODE_SIZE = 1;  //if active, can be changed by a slider in the menu area
...
var hiddenLabels = [];
var LABELING_STRATEGY = 1;  //if active, can be changed by a slider in the menu area
...
/*
// // // // // // // Visualization settings that the user can modify
//link opacity
